...
Revision ID: e99b9bacb87d
Revises: 9c214bda7dc9
Create Date: 2021-04-30 05:20:18.803193
...
revision = 'e99b9bacb87d'
down_revision = '9c214bda7dc9'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('symbols', postgresql.ARRAY(sa.INTEGER()), autoincrement=False, nullable=False),
